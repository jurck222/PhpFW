    ...
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <select name="country" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <option value="Canada" <?php if (array_key_exists('country', $oldFormData)) : echo ($oldFormData['country'] === 'Canada' ? 'selected' : '');
                                        endif; ?>>Canada</option>
                <option value="Mexico" <?php if (array_key_exists('country', $oldFormData)) : echo ($oldFormData['country'] === 'Mexico' ? 'selected' : '');
                                        endif; ?>>Mexico</option>
